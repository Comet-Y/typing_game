...
impl Plugin for SystemPlugin{
    fn build(
        ...
        app.add_systems(OnEnter(state::GameState::InGame),build_viewmodel::build_ingame_viewmodel.in_set(schedule::GameSet::ViewModel));
        app.add_systems(OnEnter(state::InGameState::Typing),(build_viewmodel::build_problem_viewmodel,build_viewmodel::update_ingame_viewmodel).in_set(schedule::GameSet::ViewModel));
        ...
        app.add_systems(FixedUpdate,timer::end_kpmdisplay.run_if(in_state(state::InGameState::DisplayKpm)));
        app.add_systems(FixedUpdate,sounds::handle_key_input_sound.run_if(in_state(state::InGameState::Typing)));
